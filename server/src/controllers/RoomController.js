...
module.exports = {
  // public/customer: view room types
  async list(req, res) {
  ...
  async create(req, res) {
    const { name, type, pricePerNight, capacityCats, description, status } = req.body
  ...
  async update(req, res) {
    ...
    const fields = ['name', 'type', 'pricePerNight', 'capacityCats', 'description', 'status']
    fields.forEach((f) => {
